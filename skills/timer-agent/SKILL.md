...
Never use `drain` for work that must survive a crash between receipt and completion. Each delivery path must keep a stable consumer name; sessions that intentionally compete for the same work share that name.
